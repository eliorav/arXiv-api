 ...
 * @return {string} query string of a tag.
 */
 ...
 * @return {string} query string between tags.
 */
 ...
 * @return {Promise}
 */
async function search({searchQueryParams, start = 0, maxResults = 10}) {
	...
	const response = await axios.get(get_arxiv_url(searchQuery, start, maxResults));
